...
const translations: Record<Lang, Record<string, string>> = {
  ru: {
    ...
    "admin.title_uz_label": "Заголовок (узбекская версия)",
    "admin.slug": "URL-адрес (slug)",
    "admin.excerpt": "Краткое описание",
    "admin.excerpt_uz_label": "Краткое описание (узбекская версия)",
    "admin.content": "Содержание (HTML)",
    "admin.content_uz_label": "Содержание (узбекская версия)",
    ...
    "admin.cat_name_uz_label": "Название (узбекская версия)",
    "admin.cat_slug": "Slug",
    "admin.cat_desc": "Описание",
    "admin.cat_desc_uz_label": "Описание (узбекская версия)",
